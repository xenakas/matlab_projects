...
semilogy([policy_l(1,:) 1./policy_u(1,:)],abs([policy_l(2,:)-policy_compare_last_iteration_l 1./policy_u(2,:)-1./policy_compare_last_iteration_u]),'LineWidth',1+figps_on)
hold on
...
ylabel('absolute change last iteration (log scale)')
xlabel('capital')
hold off
