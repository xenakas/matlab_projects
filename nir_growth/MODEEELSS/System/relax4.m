function varargout = relax4(funcODE, funcSTAT, funcINI, funcfinal, n, n1, n3, nu, guess, M, start, Endcond, maxit, tol, damp, dampfac)
% Version 3.1
% RELAXATION algorithm to solve infinite-horizon continuous time models.
% This version includes extrapolation and is, therefore, of fourth order
% instead of second order. However, the output 'error' is an estimate of the
% relative error of the second order solution an, therefore, a very crude
% error bound for the fourth order solution.
%
...
%
% COMMAND:
% [t, x, errormean] = relax4(@funcODE, @funcSTAT, @funcINI, @funcfinal, n, n1, n3, nu, y, M, start, Endcond, maxit, tol, damp, dampfac)
% 
% INPUT ARGUMENTS
...
% errormean: (optional) relative mean error of the second order solution along the mesh
%
...
x=(4*x_d(:,1:2:2*M-1)-x)/3;

varargout(1)={t};
varargout(2)={x};
varargout(3)={x_error_d_mean};
